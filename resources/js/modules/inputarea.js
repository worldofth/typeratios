...
(function InputAreaIFFE(global, document, cm){
	"use strict";
	...
	function init(textArea, inputController, isMarkdown){
		...
		if(typeof textAreaElement === "string"){
			textAreaElement = document.querySelector(textAreaElement);
		}
		...
		this.textArea = cm.fromTextArea(textAreaElement, options);
